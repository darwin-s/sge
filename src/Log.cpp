...
const char* getMtText(sge::Log::MessageType mt) {
  switch (mt) {
  case sge::Log::MessageType::Info:return "INF";
    break;
  case sge::Log::MessageType::Warning:return "WRN";
    break;
  case sge::Log::MessageType::Error:return "ERR";
    break;
  case sge::Log::MessageType::Debug:return "DBG";
    break;
  default:return "UNK";
    break;
  }
